...
def process_mmseqs(id: str, cov: str, multifasta: str, output_dir: str, num_workers: int = None, mmseqs_path: str = None):
...
def main():
    ...
    parser.add_argument('-m', '--mmseqs_path', required=True, help="Path to the mmseqs binary")
    ...
    parser.add_argument('-j', '--workers', type=int, help="Number of worker threads for mmseqs (optional)")
    args = parser.parse_args()

    process_mmseqs(args.id, args.cov, args.fasta, args.output_dir, args.workers, args.mmseqs_path)
