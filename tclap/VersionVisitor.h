 ...
 * for the specified CmdLine object and then exit.
 */
class ChangeLogVisitor: public Visitor
{
private:
    /**
     * Prevent accidental copying
     */
    ChangeLogVisitor(const ChangeLogVisitor& rhs);
    ChangeLogVisitor& operator=(const ChangeLogVisitor& rhs);
...
public:
     ...
     * \param out - The type of output.
     */
    ChangeLogVisitor( CmdLineInterface* cmd, CmdLineOutput** out )
				: Visitor(), _cmd( cmd ), _out( out ) { }
